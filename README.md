...
```hcl
github.com/pbs/terraform-aws-ecs-service-module?ref=6.1.4
```
...
```hcl
module "service" {
  source = "github.com/pbs/terraform-aws-ecs-service-module?ref=6.1.4"
...
| <a name="module_task"></a> [task](#module\_task) | github.com/pbs/terraform-aws-ecs-task-definition-module | 2.1.2 |
