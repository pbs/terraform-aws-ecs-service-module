...
```hcl
github.com/pbs/terraform-aws-ecs-service-module?ref=4.1.23
```
...
```hcl
module "service" {
  source = "github.com/pbs/terraform-aws-ecs-service-module?ref=4.1.23"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cluster"></a> [cluster](#module\_cluster) | github.com/pbs/terraform-aws-ecs-cluster-module | 0.0.16 |
